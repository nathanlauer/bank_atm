...
public class SavingsAccount extends Account {
     ...
     */
    public SavingsAccount(Currency currency, Money money, List<User> managers) {
     ...
     */
    public SavingsAccount(Date opened, Currency currency, Money money, List<User> managers) {
