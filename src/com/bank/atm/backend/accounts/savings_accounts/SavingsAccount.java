...
public class SavingsAccount extends Account {
     ...
     */
    public SavingsAccount(Currency currency, Money money, List<UserID> managers) {
     ...
     */
    public SavingsAccount(Date opened, Currency currency, Money money, List<UserID> managers) {
