...
public class LowInterestSavingsAccountFactory implements AccountFactoryCreator {
     ...
     */
    public LowInterestSavingsAccountFactory(Currency currency, double initialAmount, User user) {
    ...
    public Account createAccount() {
        ...
        return new LowInterestSavingsAccount(currency, new Money(initialAmount), managers);
    }
}
